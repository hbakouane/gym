...
Route::group(['middleware' => ['auth']], function () {
    Route::get('/project/create', [ProjectsController::class, 'showCreateProjectForm'])->name('project.create');
});

Route::get('/projects/manage', [ProjectsController::class, 'manageProjects'])->name('projects.manage')->middleware(['auth:web']);
