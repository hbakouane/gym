<div wire:poll>
    ...
    @include('partials.errors')
     <div class="row">
         ...
         <div class="col-md-9">
             <div class="card">
                 <div class="card-header h4 text-dark font-weight-bold w-100">{{ __('payments.Payments') . ' ' . strtolower(__('general.Details')) }}</div>
                 <div class="card-body">
                     <form wire:submit.prevent="save">
                         <div class="row">
                            ...
                            @if($payable_type)
                            <div class="col-md-12">
                                @if(count(App\Models\Member::all()) == 0 AND $payable_type == 'member')
                                    <p class="text-warning">You have 0 members.</p>
                                @endif
                                @if(count(App\Models\Vendor::all()) == 0 AND $payable_type == 'vendor')
                                    <p class="text-warning">You have 0 vendors.</p>
                                @endif
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
