<div>
    ...
    <p class="text-muted text-right" style="cursor: pointer" wire:click="toggleFilter()">{!! $filter ? '<i class="fa fa-times"></i>' : '<i class="fa fa-info-circle"></i>' !!} {{ __('general.Filter') }}</p>
    @if($filter)
        <div class="card">
            <div class="card-body">
                <div class="row">
    ...
    <!-- ============================================================== -->
        ...
        @else
        <p class="text-muted">{{ __('general.Refresh the page to display the charts again.') }}</p>
        @endif
    @else
