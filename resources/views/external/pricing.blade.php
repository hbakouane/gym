<div class="position-relative overflow-hidden bg-default pt-md-21 pt-15 pb-lg-13 pb-10 z-index-1" id="pricing">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-lg-8 px-0 text-center aos-init aos-animate" data-aos="fade-down" data-aos-duration="800" data-aos-once="true">
                ...
                <p class="text-default-color-4 font-size-7 line-height-1p714 mb-11 font-family-inter">We have the most affordable prices.</p>
                ...
                <div style="border-radius: 24px;" class="shadow bg-white single-price border bg-default pt-9 pb-10 mb-lg-0 mb-9 pl-12 pr-lg-21 pr-sm-15 pr-11 shadow-13 hover-shadow-3 aos-init aos-animate" data-aos="fade-right" data-aos-duration="800" data-aos-once="true">
                    ...
                    <!--<div class="price-body pt-8">
                        <ul class="pricing-list with-check-icon list-unstyled mb-9">
                            ...
                            <li class="font-size-5 text-default-color-2 letter-spacing-np45 font-weight-normal font-family-5 mb-3"> 
                                <i class="icon text-success icon-check-2-2 mr-4 text-default-color-2"></i> 15 Staves per project
                            </li>
                            <li class="font-size-5 text-default-color-2 letter-spacing-np45 font-weight-normal font-family-5 mb-3">
                                <i class="icon text-success icon-check-2-2 mr-4"></i> 400 Members per project
                            </li>
                            <li class="font-size-5 text-default-color-2 letter-spacing-np45 font-weight-normal font-family-5 mb-3">
                                <i class="icon text-success icon-check-2-2 mr-4"></i> 400 Memberships per project
                            </li>
