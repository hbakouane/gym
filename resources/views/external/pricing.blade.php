                ...
                <div class="single-price border bg-default pt-9 pb-10 mb-lg-0 mb-9 pl-12 pr-lg-21 pr-sm-15 pr-11 shadow-13 hover-shadow-3" data-aos="fade-right" data-aos-duration="800" data-aos-once="true">
                    ...
                    <div class="main-price">
                        <div class="price mt-3 position-relative pl-7">
                            ...
                            <h2 class="heading-default-color d-inline-block mb-0 font-size-22 font-weight-bold font-family-3 line-height-1p304 dynamic-value" data-active="15" data-monthly="14.99" data-yearly="149"></h2>
                    ...
                    <!-- main-price end -->
                    <p class="font-family-5 font-size-3 letter-spacing-np4 text-default-color-4 mb-0">{{ __('external.Good for small businesses') }}</p>
                    <!-- price-body start -->
                    <div class="price-body pt-8">
                        <ul class="pricing-list with-check-icon list-unstyled mb-9">
                            <li class="font-size-5 text-default-color-2 letter-spacing-np45 font-weight-normal font-family-5 mb-3"> 
                                <i class="icon text-success icon-check-2-2 mr-4 text-default-color-2"></i> {{ __('external.1 Project') }}
                            </li>
                            <li class="font-size-5 text-default-color-2 letter-spacing-np45 font-weight-normal font-family-5 mb-3"> 
                                <i class="icon text-success icon-check-2-2 mr-4 text-default-color-2"></i> {{ __('external.5 Staves') }}
                            </li>
                            <li class="font-size-5 text-default-color-2 letter-spacing-np45 font-weight-normal font-family-5 mb-3">
                                <i class="icon text-success icon-check-2-2 mr-4"></i> {{ __('external.200 Members') }}
                            </li>
                            <li class="font-size-5 text-default-color-2 letter-spacing-np45 font-weight-normal font-family-5 mb-3">
                                <i class="icon text-success icon-check-2-2 mr-4"></i> {{ __('external.200 Memberships') }}
                            </li>
                            </li>
                            <li class="font-size-5 text-default-color-2 letter-spacing-np45 font-weight-normal font-family-5 mb-3">
                                <i class="icon text-success icon-check-2-2 mr-4"></i> {{ __('external.7 Days Trial') }}
                            </li>
                            </li>
                            <li class="font-size-5 text-default-color-2 letter-spacing-np45 font-weight-normal font-family-5 mb-3">
                                <i class="icon text-success icon-check-2-2 mr-4"></i> {{ __('external.Data backup') }}
                            </li>
                        </ul>
                    </div>
                    <!-- price-body end -->
                    ...
                    <!-- price-btn end -->
                    <p class="font-size-3 text-dovegray font-family-5 mb-0 mt-5">{{ __('external.credit-card') }}</p>
                </div>
                <!-- single-price end -->
            </div>
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-8">
                <div class="alert border-0 mb-0 rounded-0 text-center alert-success shadow border" data-aos="fade-right" data-aos-duration="800" data-aos-once="true">
                ...
                <div class="single-price border bg-default pt-9 pb-10 mb-lg-0 mb-9 pl-12 pr-lg-21 pr-sm-15 pr-11 shadow-13 hover-shadow-3" data-aos="fade-right" data-aos-duration="800" data-aos-once="true">
                    ...
                    <div class="main-price">
                        <div class="price mt-3 position-relative pl-7">
                            <span class="text-default-color-2 d-inline-block letter-spacing-n1p2 mb-0 font-size-13 font-weight-bold font-family-5 dynamic-value pos-abs-tl mt-md-3">$</span>
                            <h2 class="heading-default-color d-inline-block mb-0 font-size-22 font-weight-bold font-family-3 line-height-1p304 dynamic-value" data-active="15" data-monthly="24.99" data-yearly="149"></h2>
                            <span class="text-default-color-2 font-size-6 font-family-5 font-weight-bold letter-spacing-np3 dynamic-value line-height-reset" data-active="/ month" data-monthly="/ month" data-yearly="/ year"></span>
                        </div>
                    </div>
                    <!-- main-price end -->
                    <p class="font-family-5 font-size-3 letter-spacing-np4 text-default-color-4 mb-0">{{ __('external.Good for intermediate businesses') }}</p>
                    <!-- price-body start -->
                    <div class="price-body pt-8">
                        <ul class="pricing-list with-check-icon list-unstyled mb-9">
                            <li class="font-size-5 text-default-color-2 letter-spacing-np45 font-weight-normal font-family-5 mb-3"> 
                                <i class="icon text-success icon-check-2-2 mr-4 text-default-color-2"></i> {{ __('external.3 Project') }}
                            </li>
                            <li class="font-size-5 text-default-color-2 letter-spacing-np45 font-weight-normal font-family-5 mb-3"> 
                                <i class="icon text-success icon-check-2-2 mr-4 text-default-color-2"></i> {{ __('external.15 Staves') }}
                            </li>
                            <li class="font-size-5 text-default-color-2 letter-spacing-np45 font-weight-normal font-family-5 mb-3">
                                <i class="icon text-success icon-check-2-2 mr-4"></i> {{ __('external.500 Members') }}
                            </li>
                            <li class="font-size-5 text-default-color-2 letter-spacing-np45 font-weight-normal font-family-5 mb-3">
                                <i class="icon text-success icon-check-2-2 mr-4"></i> {{ __('external.500 Memberships') }}
                            </li>
                            </li>
                            <li class="font-size-5 text-default-color-2 letter-spacing-np45 font-weight-normal font-family-5 mb-3">
                                <i class="icon text-success icon-check-2-2 mr-4"></i> {{ __('external.7 Days Trial') }}
            ...
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-8">
                ...
                <div class="single-price border bg-default pt-9 pb-10 mb-lg-0 mb-9 pl-12 pr-lg-21 pr-sm-15 pr-11 shadow-13 hover-shadow-3" data-aos="fade-right" data-aos-duration="800" data-aos-once="true">
                    ...
                    <div class="main-price">
                        <div class="price mt-3 position-relative pl-7">
                            <span class="text-default-color-2 d-inline-block letter-spacing-n1p2 mb-0 font-size-13 font-weight-bold font-family-5 dynamic-value pos-abs-tl mt-md-3">$</span>
                            <h2 class="heading-default-color d-inline-block mb-0 font-size-22 font-weight-bold font-family-3 line-height-1p304 dynamic-value" data-active="15" data-monthly="39.99" data-yearly="149"></h2>
                            <span class="text-default-color-2 font-size-6 font-family-5 font-weight-bold letter-spacing-np3 dynamic-value line-height-reset" data-active="/ month" data-monthly="/ month" data-yearly="/ year"></span>
                        </div>
                    </div>
                    <!-- main-price end -->
                    <p class="font-family-5 font-size-3 letter-spacing-np4 text-default-color-4 mb-0">{{ __('external.Good for big businesses') }}</p>
                    <!-- price-body start -->
                    <div class="price-body pt-8">
                        <ul class="pricing-list with-check-icon list-unstyled mb-9">
                            <li class="font-size-5 text-default-color-2 letter-spacing-np45 font-weight-normal font-family-5 mb-3"> 
                                <i class="icon text-success icon-check-2-2 mr-4 text-default-color-2"></i> {{ __('external.5 Project') }}
                            </li>
                            <li class="font-size-5 text-default-color-2 letter-spacing-np45 font-weight-normal font-family-5 mb-3"> 
                                <i class="icon text-success icon-check-2-2 mr-4 text-default-color-2"></i> {{ __('external.30 Staves') }}
                            </li>
                            <li class="font-size-5 text-default-color-2 letter-spacing-np45 font-weight-normal font-family-5 mb-3">
                                <i class="icon text-success icon-check-2-2 mr-4"></i> {{ __('external.800 Members') }}
                            </li>
                            <li class="font-size-5 text-default-color-2 letter-spacing-np45 font-weight-normal font-family-5 mb-3">
                                <i class="icon text-success icon-check-2-2 mr-4"></i> {{ __('external.800 Memberships') }}
                            </li>
                            </li>
                            <li class="font-size-5 text-default-color-2 letter-spacing-np45 font-weight-normal font-family-5 mb-3">
                                <i class="icon text-success icon-check-2-2 mr-4"></i> {{ __('external.7 Days Trial') }}
